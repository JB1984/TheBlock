...
class Blockchain:
    ...
    def verify_transaction_signature(self, sender_address, signature, transaction):
        ...
        ### Check that the provided signature corresponds to transaction signed by the public key (sender_address)
    ...
    def valid_proof(self, transactions, last_hash, nonce, difficulty=MINING_DIFFICULTY):
        ...
        ### Check is a hash value satisfies the mining conditions
...
def register_nodes():
    ...
    response= {'message': 'New nodes have been added', 'total_nodes': [node for node in blockchain.nodes]}
    return jsonify(response), 201
